...
source("county-scrapers/washington.R")

raw.results <- get_washington(county_last("raw/aug2026", "washington")) |>
  filter(str_detect(ward, "DODGE", negate = T))
saveRDS(raw.results, "processed/aug2026/washington.rds")
...
saveRDS(reporting.units.polygons, "county-rep-unit-polygons/washington.rds")
# ###############################################################################